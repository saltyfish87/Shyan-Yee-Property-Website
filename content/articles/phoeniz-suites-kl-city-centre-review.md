...
faqs:
  ...
  - q: What is the starting price of Phoeniz Suites?
    a: From RM 1,016,400, or about RM 2,100 per square foot. Ask for the current price list, as it changes with each release.
  - q: What is the maintenance fee at Phoeniz Suites?
    a: RM 1.21 psf including sinking fund. The developer states it will subsidise up to RM 0.33 psf for the first two years, so confirm the exact figure and period in writing.
  - q: What sizes are available at Phoeniz Suites?
    a: Three layout families from 484 sq ft (1 + 1 bedrooms) to 678 sq ft (dual key), with 394 suites in total.
  - q: When will Phoeniz Suites be completed?
    a: The construction period is 60 months after the advertising permit and developer's licence is obtained, putting completion around 2031.
---
